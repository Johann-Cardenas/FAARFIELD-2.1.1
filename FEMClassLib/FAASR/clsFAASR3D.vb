...
Partial Public Class clsFEM
    ...
    Public Sub FAASR3D(ByVal IPC As InputCards, ByRef Stress1() As Double, ByRef Stress8() As Double,
                       ...
                       ByVal WorkingDir As String, ByVal Filenameonly As String, ByVal ModelOut As Integer, ByRef ct As CancellationToken)
        ...
        Call EraseOutput()
        Call InitialSet(I1, bIDCase, lutty, WorkingDir & "PrintOut-" & Filenameonly, ModelOut) 'ik2019.12.16
        ...
        For IStep = 1 To Ntimestep
            ...
            Call com.get_time(t1)
            Call objSolve.solve(ini, IStep, Stress1, Stress8, ModelOut, ct)
        ...
        Call EraseInput(lutty, ModelOut) 'ik2019.12.17
