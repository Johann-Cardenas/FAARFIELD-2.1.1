...
Partial Public Class clsSolve
    ...
    ''' </summary>
    Public Sub solve(ByVal ini As Object, ByVal istep As Integer, ByRef Stress1() As Double, ByRef Stress8() As Double, ByVal ModelOut As Integer, ByRef ct As CancellationToken)
...
130:        lplot = lplotm
            ...
            If Not llpass Then
                ...
                If ModelOut = 1 Then 'ik2019.12.17
            ...
            'Print(lutty, newtext)
            Call quasin(un3, un4, un5, tvc2, un2, un6, time, ierr, ModelOut)            ' QW 11-11-2015
            'Call get_time(t2)
...
140:
            ...
            Call objPrintout.prtout(FilenameOnly, kpri, mpri, npri, iadd, maxsiz, Stress1, Stress8, incflg, lhex, numelg, ihv,
                                    nh04, nh05, nstep, idroer, ncon, anegb1, anegb2, incpr, dehva, timep, npb, ipnode, un2, ModelOut) ' QW 12-12-2018-
