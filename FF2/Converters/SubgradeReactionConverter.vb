...
Namespace Converters
    ...
    Public Class SubgradeReactionConverter
        ...
        Public Function Convert(values() As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IMultiValueConverter.Convert
            If values(0) Is Nothing
                Return ""
            End If
            If values(1) Is DependencyProperty.UnsetValue Or values(0) Is DependencyProperty.UnsetValue
                Return ""
            End If
            Previous = values(0)
        ...
        Public Function ConvertBack(value As Object, targetTypes() As Type, parameter As Object, culture As CultureInfo) As Object() Implements IMultiValueConverter.ConvertBack
            ...
            Try
                return {New SubgradeReaction(value,MeasurementSystem), MeasurementSystem}
