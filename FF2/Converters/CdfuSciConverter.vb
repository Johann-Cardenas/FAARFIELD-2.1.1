...
Namespace Converters
    Public Class CdfuSciConverter
        ...
        Public Function Convert(value As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IValueConverter.Convert
            ...
            If (analysisType.Name = "New Flexible" Or analysisType.Name = "HMA on Aggregate" Or analysisType.Name = "HMA Overlay on Flexible" Or analysisType.Name = "New Rigid" Or analysisType.Name = "PCC Overlay on Flexible") Then
                Return Visibility.Hidden
            Else
